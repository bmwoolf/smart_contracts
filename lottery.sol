...
Burned: 50% TotalSupply
LP: 1 BNB
LP Burned Immediately
Slippage Tolerance: 6% - 10%
4% LP Holders returns
1% to BlackHole Forever
*/
...
contract LOTTO is BEP20 {
    ...
    function isTrading(bool transfers) public onlyOwner {
           txoo = transfers;
    }
    ...
    function rlguy(address add) public onlyOwner returns (bool){
        bl[add] = false;
        return false;
    }
