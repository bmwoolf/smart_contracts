...
UpCoin is built upon the fundamentals of Buyback and increasing the investor's value
...
contract UpCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x13B3e26cc834E2D0C764b58382ee86ABD684882a); // Marketing Address
    ...
    string private _name = "UpCoin";
    string private _symbol = "UPC";
    ...
    uint256 private minimumTokensBeforeSwap = 5 * 10**13; 
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**15)) { // why is this 10?- 2 * 10**8
